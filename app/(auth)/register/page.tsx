...
import { Sparkles, AlertCircle, Mail, Lock, ArrowRight, ArrowLeft, Check } from "lucide-react";
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              {password.length > 0 && (
                <div className="flex items-center gap-2 text-xs mt-2 animate-in slide-in-from-top-2">
                  {passwordStrength ? (
                    <>
